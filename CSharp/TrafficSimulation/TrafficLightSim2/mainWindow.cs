...
namespace TrafficLightSim2
{
    public partial class mainWindow : Form
    {
        ...
        public mainWindow(Intersection modelIntersection, SimulationEnvironment simulation)
        {
            ...
            lightsCycleButton.Location = new Point(400, 530);

            Controls.Add(runSimulationButton);
            Controls.Add(stopSimulationButton);
            Controls.Add(lightsCycleButton);
            lightsCycleButton.Hide();
            runMultiMenuItem.Visible = false;
            runMenuItem.Visible = false;
            ...
            lightsCycleButton.Click += new System.EventHandler(lightCycleListener);
            runMenuItem.Click += new EventHandler(lightCycleListener);
            runMultiMenuItem.Click += new EventHandler(multiLightCycleListener);
        ...
        private void lightCycleListener(object sender, System.EventArgs e)
        {
        ...
        private void multiLightCycleListener(object sender, System.EventArgs e)
        {
            setMultiCycle subForm = new setMultiCycle(this, this.simulation);
            subForm.Show();
        }
        ...
        private void simulationToggle(object sender, System.EventArgs e)
        {
            ...
            {
                runMultiMenuItem.Visible = true;
                runMenuItem.Visible = true;
                lightsCycleButton.Show();
